...
public class JavaCameraView extends CameraBridgeViewBase implements PreviewCallback {
    ...
    public List<String> focusModes=new ArrayList<>();

//    public static class JavaCameraSizeAccessor implements ListItemAccessor {//弃用源码，自己重写计算宽高的方法
//
//        @Override
        ...
        synchronized (this) {
            ...
            try {
                ...
                for (int i = 0; i < cameraSizes.size(); i++) {
                    Camera.Size temp = cameraSizes.get(i);
                ...
                if (sizes != null) {
                    ...
                    Log.d(TAG, "Set preview size to " + frameSize.getWidth() + "x" + frameSize.getHeight());
